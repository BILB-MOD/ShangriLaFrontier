package net.mcreator.shangrilafrontier;
...
@Mod("shangrila_frontier")
public class ShangrilaFrontierMod {
	public static final Logger LOGGER = LogManager.getLogger(ShangrilaFrontierMod.class);
	public static final String MODID = "shangrila_frontier";

	public ShangrilaFrontierMod() {
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									ShangrilaFrontierMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			ShangrilaFrontierMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
